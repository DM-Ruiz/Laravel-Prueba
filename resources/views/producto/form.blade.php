<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            {{ Form::label('poseeiva') }}
            {{ Form::text('poseeiva', $producto->poseeiva, ['class' => 'form-control' . ($errors->has('poseeiva') ? ' is-invalid' : ''), 'placeholder' => 'Poseeiva']) }}
            {!! $errors->first('poseeiva', '<div class="invalid-feedback">:message</p>') !!}
        </div>
